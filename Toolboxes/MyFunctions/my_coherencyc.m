function [C,phi,S12,S1,S2,f,confC,phistd,Cerr]=my_coherencyc(data1,data2,params) 
%% This is a modified version of coherencyc function of chronux which calculates the phase coherence. 
%% This function only works when chronux is added to path. 
...
J1 = J1./abs(J1); % Modified 20200303
J2=mtfftc(data2,tapers,nfft,Fs);
J2 = J2./abs(J2); % Modified 20200303
