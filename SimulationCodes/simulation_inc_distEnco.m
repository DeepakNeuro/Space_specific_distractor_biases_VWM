%{
Simulation model with increased distractor encoding strength
%}

function [ang_cu_mat, ang_uc_mat, metrics] = simulation_inc_distEnco(ori_deg, dist_params, rng_seed)
...
stimulus_cu = stim*v_cu';                          stimulus_uc = stim*v_uc';                              stimulus_dist = 8*stim*v_d'; 
