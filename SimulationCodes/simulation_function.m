%{
Simulation function called by the Model_main.m script to simulate the ring
attractor model with the given memoranduma and distractor parameters across
time.
%}

function [ang_cu_mat, ang_uc_mat, metrics] = simulation_function(ori_deg, dist_params, rng_seed)
